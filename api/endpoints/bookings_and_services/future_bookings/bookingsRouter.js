      ...
      console.log(booking)
        ...
        .then(provider => {
          ...
          const providerMailOptions = {
            ...
            text: `Dear ${provider.first_name}, you have just confirmed your booking for ${booking[0].services_and_pricing} on  the date ${booking[0].booking_date} at ${booking[0].booking_time} with ${booking[0].user_name}.  The service location address is ${booking[0].service_address}. Your booking id is ${booking[0].id}. Thank you for partnering with maniPed!`
          }
        ...
        .then(user => {
          ...
          const userMailOptions = {
            ...
            text: `Hello ${user.first_name}, your booking for ${booking[0].services_and_pricing} on the date ${booking[0].booking_date} at ${booking[0].booking_time} with ${booking[0].provider_name} has just been updated.  The service location address is ${booking[0].service_address}. Your booking id is ${booking[0].id}.  Thank you for choosing maniPed for your cosmetic needs!`
          }
          transporter.sendMail(userMailOptions, function(err, info) {
            if (err) {
              console.log(err)
...
router.post('/', (req, res) => {
    ...
    Bookings.add(req.body)
      .then(booking => {
        ...
        .catch(err => {
          console.log("error sending email to provider")
